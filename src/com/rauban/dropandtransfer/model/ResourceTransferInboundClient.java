...
public class ResourceTransferInboundClient extends ResourceTransferAbstractClient {
	private String downloadPath;
	private InputStream is = null;
	private ResourceOutputStream ros = null;
	public ResourceTransferInboundClient(Socket socket, String downloadPath) {
		super();
		this.socket = socket; 
